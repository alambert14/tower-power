...
file1 = open('ResTime_parse1.txt','r+')
file2 = open('ResTime_parse2.txt','r+')
file3 = open('ResTime_parse3.txt','r+')
file4 = open('ResTime_parse4.txt','r+')
file5 = open('ResTime_parse5.txt','r+')
file6 = open('ResTime_parse6.txt','r+')
file7 = open('ResTime_parse7.txt','r+')
file8 = open('ResTime_parse8.txt','r+')
file9 = open('ResTime_parse9.txt','r+')
file10 = open('ResTime_parse10.txt','r+')
...
print final_list
write_file = open('distances_matched_restime.txt','w+')
