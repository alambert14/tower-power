...
file1 = open('ThroughIn_parse1.txt','r+')
file2 = open('ThroughIn_parse2.txt','r+')
file3 = open('ThroughIn_parse3.txt','r+')
file4 = open('ThroughIn_parse4.txt','r+')
file5 = open('ThroughIn_parse5.txt','r+')
file6 = open('ThroughIn_parse6.txt','r+')
file7 = open('ThroughIn_parse7.txt','r+')
file8 = open('ThroughIn_parse8.txt','r+')
file9 = open('ThroughIn_parse9.txt','r+')
file10 = open('ThroughIn_parse10.txt','r+')
...
print final_list
write_file = open('distances_matched_throughin.txt','w+')
