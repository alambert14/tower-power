...
file1 = open('ThroughOut_parse1.txt','r+')
file2 = open('ThroughOut_parse2.txt','r+')
file3 = open('ThroughOut_parse3.txt','r+')
file4 = open('ThroughOut_parse4.txt','r+')
file5 = open('ThroughOut_parse5.txt','r+')
file6 = open('ThroughOut_parse6.txt','r+')
file7 = open('ThroughOut_parse7.txt','r+')
file8 = open('ThroughOut_parse8.txt','r+')
file9 = open('ThroughOut_parse9.txt','r+')
file10 = open('ThroughOut_parse10.txt','r+')
...
print final_list
write_file = open('distances_matched_throughout.txt','w+')
